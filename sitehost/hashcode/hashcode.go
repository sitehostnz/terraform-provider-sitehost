...
// this is based on the file from
// https://github.com/fastly/terraform-provider-fastly/blob/main/LICENSE
// https://github.com/fastly/terraform-provider-fastly/blob/main/fastly/hashcode/hashcode.go
package hashcode
